...
#include "refVelocityPseudoSolidFvMotionSolver.H"
...
namespace Foam
{
    defineTypeNameAndDebug(refVelocityPseudoSolidFvMotionSolver, 0);
...
Foam::refVelocityPseudoSolidFvMotionSolver::refVelocityPseudoSolidFvMotionSolver
(
    const polyMesh& mesh,
    Istream&
)
...
Foam::refVelocityPseudoSolidFvMotionSolver::curPoints() const
{
...
void Foam::refVelocityPseudoSolidFvMotionSolver::updateMesh
(
