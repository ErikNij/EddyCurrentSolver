...
d.vertices.set(17, [-geo_lx0, -geo_ly0,  geo_fz2])
d.vertices.set(18, [ geo_lx0, -geo_ly0,  geo_fz2])
d.vertices.set(19, [ geo_lx1, -geo_ly0,  geo_fz1])
d.vertices.set(20, [-geo_lx1,  geo_ly0,  geo_fz0])
d.vertices.set(21, [-geo_lx0,  geo_ly0,  geo_fz2])
d.vertices.set(22, [ geo_lx0,  geo_ly0,  geo_fz2])
...
d.vertices.set(60, [-geo_lx0, -geo_ly0,  geo_fz0])
d.vertices.set(61, [ geo_lx0, -geo_ly0,  geo_fz1])
d.vertices.set(62, [-geo_lx0,  geo_ly0,  geo_fz0])
d.vertices.set(63, [ geo_lx0,  geo_ly0,  geo_fz1])
...
d.blocks.set( 7, [ 34,  9, 13, 35, 36, 17, 21, 37], zone="region_static")
d.blocks.set( 8, [  9, 10, 14, 13, 60, 61, 63, 62], zone="region_fluid")
d.blocks.set( 9, [ 10, 44, 45, 14, 18, 46, 47, 22], zone="region_static")
d.blocks.set(10, [ 44, 11, 15, 45, 46, 19, 23, 47], zone="region_static")
d.blocks.set(11, [ 16, 36, 37, 20, 52, 38, 39, 53], zone="region_static")
d.blocks.set(12, [ 36, 17, 21, 37, 38, 54, 55, 39], zone="region_static")
d.blocks.set(13, [ 60, 61, 63, 62, 54, 56, 57, 55], zone="region_dynamic")
d.blocks.set(14, [ 18, 46, 47, 22, 56, 48, 49, 57], zone="region_static")
...
d.blocks.distribution.set( 6, "z", 20)
d.blocks.distribution.set(10, "z", 20)
d.blocks.distribution.set(11, "z", 30)
d.blocks.distribution.set(13, "z", 30)
d.blocks.distribution.set(15, "z", 30)
...
d.boundaryFaces.set( 7, "ggiLeftStatic", [  7, 12], "x+")
d.boundaryFaces.set(10, "ggiLeftDynamic", [  8, 13], "x-")

d.boundaryFaces.set( 8, "ggiRightStatic", [  9, 14], "x-")
d.boundaryFaces.set( 9, "ggiRightDynamic", [  8, 13], "x+")
...
if d.subDict("boundary"):
    ...
    if d.boundarySubDict("ggiLeftStatic", "patch"):

        d.boundaryFaces.write()

    if d.boundarySubDict("ggiLeftDynamic", "patch"):

        d.boundaryFaces.write()

    if d.boundarySubDict("ggiRightStatic", "patch"):

        d.boundaryFaces.write()

    if d.boundarySubDict("ggiRightDynamic", "patch"):
