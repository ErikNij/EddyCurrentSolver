...
void freeSurface::makeTemperature() const
{
    if (debug)
    {
        Info<< "freeSurface::makeTemperature() : "
            << "making free-surface temparature field"
            << endl;
    }
    ...
    if (temperaturePtr_)
    {
        FatalErrorIn("freeSurface::makeTemperature()")
            << "free-surface temperature field already exists"
            << abort(FatalError);
    }
...
void freeSurface::makeSurfaceTensionForce() const
{
    if (debug)
    {
        Info<< "freeSurface::makeSurfaceTensionForce() : "
    ...
    {
        FatalErrorIn("freeSurface::makeSurfaceTensionForce()")
...
areaScalarField& freeSurface::temperature()
{
    if (!temperaturePtr_)
    {
        makeTemperature();
...
const areaScalarField& freeSurface::temperature() const
{
    if (!temperaturePtr_)
    {
        makeTemperature();
...
const areaVectorField& freeSurface::surfaceTensionForce() const
{
    if (!surfaceTensionForcePtr_)
    {
