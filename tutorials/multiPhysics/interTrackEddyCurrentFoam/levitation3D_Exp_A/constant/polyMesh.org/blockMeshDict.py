...
n0 = int(m.ceil(10 * n_scale*(geo_r0)))
n1 = int(m.ceil(10 * n_scale*(geo_r1-geo_r0)))
n2 = int(m.ceil( 2 * n_scale*(geo_r2-geo_r1)))
#n0 = int(m.ceil(10 * n_scale*(geo_r0)))
#n1 = int(m.ceil(17 * n_scale*(geo_r1-geo_r0)))
#n2 = int(m.ceil( 3 * n_scale*(geo_r2-geo_r1)))
...
print "r0 = ", geo_r0 * geo_scale
print "r1 = ", geo_r1 * geo_scale
print "r2 = ", geo_r2 * geo_scale
...
print "d0 = ", d0 * geo_scale
print "d1 = ", d1 * geo_scale
print "d2 = ", d2 * geo_scale
...
d.blocks.grading.set( 0, [1.0/g0, 1.0, 1.0])
d.blocks.grading.set( 1, [1.0/g1, 1.0, 1.0])
d.blocks.grading.set( 4, [    g2, 1.0, 1.0])
