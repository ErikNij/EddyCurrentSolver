...
d.vertices.copyTranslate( 50, baseVertices, [0.0, 0.0, par.geo_z5-par.geo_z0])
...
d.blocks.copyShiftVerticeLabels(  40, baseBlocks,  40)
...
lz4 = par.geo_z5-par.geo_z4

NR0 = 53
NR1 = 19
NZ  = 65

nr0 = int(m.ceil(par.mesh_scale*NR0))
nr1 = int(m.ceil(par.mesh_scale*NR1))
nr2 = int(m.ceil(par.mesh_scale*1))

nz0 = int(m.ceil(par.mesh_scale*1))
nz1 = int(m.ceil(par.mesh_scale*NR1))
nz2 = int(m.ceil(par.mesh_scale*NZ))
nz3 = int(m.ceil(par.mesh_scale*NR1))
nz4 = int(m.ceil(par.mesh_scale*1))

e1 = 0.205
e2 = 1.0
e2ds = expansion_de_e(nr1, e1, lr1)
e2de = 15.0 * e2ds * lr2/90.0
e2 = e2de/e2ds
...
d.blocks.distribution.set( 40, "z", nz4)
...
d.blocks.grading.set(20, [1.0, 1.0,    1.0])
d.blocks.grading.set(30, [1.0, 1.0,     e1])
d.blocks.grading.set(40, [1.0, 1.0,     e2])
...
d.boundaryFaces.set( 40, "mirror_x", 40, "x-")
d.boundaryFaces.set( 41, "mirror_x", 42, "x-")
d.boundaryFaces.set( 42, "mirror_x", 44, "x-")
...
d.boundaryFaces.set( 43, "mirror_y", 40, "y-")
d.boundaryFaces.set( 44, "mirror_y", 41, "y-")
d.boundaryFaces.set( 46, "mirror_y", 43, "y-")
...
d.boundaryFaces.set( 130, "infinity", 40, "z+")
d.boundaryFaces.set( 131, "infinity", 41, "z+")
d.boundaryFaces.set( 132, "infinity", 42, "z+")
d.boundaryFaces.set( 133, "infinity", 43, "z+")
d.boundaryFaces.set( 134, "infinity", 44, "z+")
...
d.boundaryFaces.set( 240, "infinity", 43, "x+")
d.boundaryFaces.set( 241, "infinity", 44, "y+")
